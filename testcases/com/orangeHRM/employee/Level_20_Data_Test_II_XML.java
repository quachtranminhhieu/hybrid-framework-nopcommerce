...
public class Level_20_Data_Test_II_XML extends BaseTest {

	@Parameters({"browser", "url", "adminUsername", "adminPassword"})
	@BeforeClass
	public void beforeClass(String browserName, String appURL, String adminUserName, String adminPassword, Method method) {
	...
	// New: @Parameters({"firstname", "lastname", "fullname", "username", "password", "statusValue"})
	@Parameters({"firstname", "lastname", "fullname", "username", "password", "statusValue"})
	@Test
	public void Employee_01_Add_New_Employee(String employeeFirstName, String employeeLastName, String employeeFullName, String empUserName, String empPassword, String statusValue, Method method) {
